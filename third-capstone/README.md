<div align="center">
  <h1><b>Movie character profile</b></h1>
</div>
...
# 📖 Movie character profile <a name="about-project"></a>

**Movie character profile**  is a website for showing movie character profiles. It is a Single Page App (SPA) that allows users to:
- View actors profile simple.
to build this application, I use React,Redux.
...
- [Live Demo Link](https://atatm.github.io/thirs-capstone/)
...
```sh
  cd my-folder
  git clone https://github.com/atatm/third-capstone.git
```
